    ...
    switch (e.currentTarget.name) {
      ...
      case "create":
        setConfirmCreate(() => async () => {
          ...
          if (
            Helper.handleToastByResCode(res, TriggerToast.CREATE, toggleToast)
          ) {
            setForm(false);
            setDto(defaultDto);
            toggleRefresh();
      ...
      case "update":
        setConfirmUpdate(() => async () => {
          ...
          if (
            Helper.handleToastByResCode(res, TriggerToast.UPDATE, toggleToast)
          ) {
            setForm(false);
            toggleRefresh();
          } else {
