            ...
            <div className="flex justify-center gap-10">
                <div className="flex flex-col gap-5">
                    <div className="flex gap-5">
                        <FormSection title="Image" description="Upload from file or take a live picture with webcam." >
                                ...
                                {file || cam ?
                                    ...
                                    <>
                                        ...
                                        <div className='flex flex-wrap justify-center gap-3'>
                                            <Button disabled={isReadOnly} name='file' onClickWithEvent={handleClickInternal} startIcon={<FileIcon />}>Browse</Button>
                                            <Button disabled={isReadOnly} name='cam' onClickWithEvent={handleClickInternal} startIcon={<CamIcon />}>Take Picture</Button>
                                        </div>
                                    </>
                                }
                            </FormField>
                            ...
                            <div className="grid gap-5 grid-cols-2 md:grid-cols-2 gap-x-10 gap-y-6 mb-8 p-5">
                                ...
                                <div className='flex gap-3 mb-3 w-full col-span-2'>
                                    <FormField className="flex-1">
                                        ...
                                        <Input disabled={isReadOnly} name="title" type='text' id="title" onChange={handleChange} value={dto.title} placeholder="Mr." />
                                    </FormField>
                                    <FormField className='flex-2'>
                                        <Label htmlFor="firstName">First Name</Label>
                                        <Input disabled={isReadOnly} name="firstName" type="text" id="firstName" onChange={handleChange} value={dto.firstName} placeholder="John" />
                                    </FormField>
                                    <FormField className='flex-2'>
                                        <Label htmlFor="middleName">Middle Name</Label>
                                        <Input disabled={isReadOnly} name="middleName" type="text" id="middleName" onChange={handleChange} value={dto.middleName} placeholder="Jr" />
                                    </FormField>
                                    <FormField className='flex-2'>
                                        <Label htmlFor="lastName">Last Name</Label>
                                        <Input disabled={isReadOnly} name="lastName" type="text" id="lastName" onChange={handleChange} value={dto.lastName} placeholder="Doh" />
                                    </FormField>
                                ...
                                <FormField className="col-span-2">
                                    <Label>Address</Label>
                                    <TextArea disabled={isReadOnly} value={dto.address} onChange={(e: string) => setDto(prev => ({ ...prev, address: e }))} />
                                </FormField>
