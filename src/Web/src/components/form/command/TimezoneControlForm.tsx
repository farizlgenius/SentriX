...
export const TimezoneControlForm: React.FC<
  PropsWithChildren<CommandFormInterface>
> = ({ action, setAction, handleClickIn, options, type }) => {
    ...
    <>
      <div>
        ...
        <Select
          ...
          options={options}
          name={"arg1"}
          defaultValue={action.arg1}
          onChange={(value: string) =>
            setAction((prev) => ({
              ...prev,
              arg1: Number(value),
              mac:
                options.find((x) => x.value == Number(value))?.description ??
                "",
            }))
          }
        />
