...
public sealed class Groups : BaseDomain
{
      ...
      public Groups(int id, short componentId,string name,List<(string Mac,short DeviceComponentId,string Type,List<(short DoorComponentId,short TimezoneComponentId)> DoorDetail)> doorGroup,int locationId, bool IsActive) : base(id, componentId, locationId, IsActive)
      {
