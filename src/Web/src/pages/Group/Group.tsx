...
const Group = () => {
  ...
  const handleRemove = (data: GroupDto) => {
    setConfirmRemove(() => async () => {
      ...
      if (
        Helper.handleToastByResCode(res, AccessLevelToast.DELETE, toggleToast)
      )
        toggleRefresh();
    });
    setRemove(true);
    ...
    <>
      ...
      {form ? (
        ...
        <BaseTable<GroupDto>
          ...
          permission={filterPermission(FeatureId.group)}
          onInfo={handleInfo}
          fetchData={fetchData}
