...
export const TriggerForm: React.FC<PropsWithChildren<FormProp<TriggerDto>>> = ({
  handleClick,
  dto,
  setDto,
  type,
  ...
  const handleChange = (
    ...
    switch (e.target.name) {
      ...
      case "sourceNumber":
        setDto((prev) => ({
          ...prev,
          sourceNumber: Number(value),
          mac: device.find((x) => x.value == Number(value))?.description ?? "",
        }));
        break;
      case "codeMap":
        setDto((prev) => ({
          ...prev,
          codeMap: prev.codeMap.some((x) => x.value == Number(value))
            ? prev.codeMap
            : [
                ...prev.codeMap,
                {
                  ...
                  description:
                    code.find((x) => x.value == Number(value))?.description ??
                    "",
                },
              ],
        }));
