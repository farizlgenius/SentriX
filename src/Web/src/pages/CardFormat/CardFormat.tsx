...
export const CARDFORMAT_TABLE_HEAD: string[] = ["Name", "Facility", "Bits"];
export const CARDFORMAT_KEY: string[] = ["name", "fac", "bits"];
  ...
  return (
    <>
      ...
      {form ? (
        ...
        <BaseTable<CardFormatDto>
          headers={CARDFORMAT_TABLE_HEAD}
          keys={CARDFORMAT_KEY}
          data={cardFormatsDto}
          onInfo={handleInfo}
          onEdit={handleEdit}
          ...
          onClick={handleClick}
          permission={filterPermission(FeatureId.setting)}
          refresh={refresh}
          fetchData={fetchData}
