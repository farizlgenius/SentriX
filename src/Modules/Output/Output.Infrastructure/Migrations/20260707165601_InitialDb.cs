        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    drive_mode = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, (short)0, "", true, false, "Normal", 0, (short)0 },
                    { 2, (short)0, "", true, false, "Inverted", 0, (short)1 }
                });

            migrationBuilder.InsertData(
                schema: "output",
                table: "OutputModes",
                columns: new[] { "id", "component_id", "drive", "is_active", "is_default", "label", "location_id", "offline", "value" },
                values: new object[,]
                {
                    { 1, (short)0, (short)0, true, false, "", 0, (short)0, (short)0 },
                    { 2, (short)0, (short)1, true, false, "", 0, (short)0, (short)1 },
                    { 3, (short)0, (short)0, true, false, "", 0, (short)1, (short)16 },
                    { 4, (short)0, (short)1, true, false, "", 0, (short)1, (short)17 },
                    { 5, (short)0, (short)0, true, false, "", 0, (short)2, (short)32 },
                    { 6, (short)0, (short)1, true, false, "", 0, (short)2, (short)33 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, (short)0, "", true, false, "No Change", 0, (short)0 },
                    { 2, (short)0, "", true, false, "Inactive", 0, (short)1 },
                    { 3, (short)0, "", true, false, "Active", 0, (short)2 }
                });
        }
