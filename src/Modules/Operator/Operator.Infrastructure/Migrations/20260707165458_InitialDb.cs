    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "operator",
                table: "operators",
                columns: new[] { "id", "component_id", "email", "firstname", "gender", "is_active", "is_default", "lastname", "location_id", "middlename", "mobile", "password", "role_id", "title", "username" },
                values: new object[] { 1, (short)0, "admin@sentrix.com", "Administrator", "M", true, true, "", 0, "", "1234567890", "100000.lG1/4V/VRPZsbhf/Zqc4xw==.6vYcf+wEMSgqcaNhoZEdM9PaPxx2ZUErZhQbeMxo5OY=", 1, "Administrator", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "id", "component_id", "is_active", "is_default", "location_id", "operator_id" },
                values: new object[] { 1, (short)0, true, false, 1, 1 });
