        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    issue_code = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, (short)0, "Active cardholder record", true, false, "Active", 0, 1 },
                    { 2, (short)0, "Allow one free anti-passback pass", true, false, "One free APB", 0, 2 },
                    { 3, (short)0, "Anti-passback exempt", true, false, "APB Exempt", 0, 4 },
                    { 4, (short)0, "Use timing parameters for the disabled (ADA)", true, false, "ADA", 0, 8 },
                    { 5, (short)0, "Use timing parameters for the disabled (ADA)", true, false, "ADA", 0, 8 },
                    { 6, (short)0, "PIN Exempt for 'Card & PIN' ACR mode", true, false, "PIN Exempt", 0, 16 },
                    { 7, (short)0, "Do not change apb_loc", true, false, "No Change APB Location", 0, 32 },
                    { 8, (short)0, "Do not alter either the 'original' or the 'current' use count values", true, false, "No Change Use Limit", 0, 64 },
                    { 9, (short)0, "Do not alter the 'current' use count but change the original use limit stored in the cardholder database", true, false, "No Change Current", 0, 128 }
                });
