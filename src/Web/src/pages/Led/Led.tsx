...
const color: Options[] = [
  ...
  },
  {
    ...
    value: 7,
    additionalInfo: (
      <div className="w-3 h-3 rounded-full bg-gray-50 shadow-sm"></div>
    ),
  },
];
...
export const Led = () => {
  ...
  const updateLed = async () => {
    ...
    if (
      Helper.handleToastByResCode(res, SettingToast.UDPATE_LED, toggleToast)
    ) {
      toggleRefresh();
    }
  };
    ...
    <>
      ...
      <div className="flex flex-col gap-5">
        <div className="flex justify-center items-center rounded-xl border border-gray-200 p-6 dark:border-gray-800 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] ">
          <Select
            name={"ledmode"}
            options={LedModeTable}
            defaultValue={selectedMode}
            onChange={(e) => setSelectedMode(Number(e))}
          />
        </div>
              ...
              return (
                <React.Fragment key={i}>
                  ...
                  <div>
                    <Select
                      icon={
                        color.find((x) => x.value === config.onColor)
                          ?.additionalInfo ?? ""
                      }
                      options={color}
                  ...
                  <div>
                    <Select
                      icon={
                        color.find((x) => x.value === config.offColor)
                          ?.additionalInfo ?? ""
                      }
                      options={color}
