...
export const AuditTrail = () => {
      ...
      const [header, setHeader] = useState<string[]>(
            headerOptions.filter((opt) => opt.selected).map((opt) => opt.text),
      );
      const [keys, setKeys] = useState<string[]>(
            headerOptions.filter((opt) => opt.selected).map((opt) => opt.value),
      );
      ...
      return (
            <>
                  ...
                  <div className="flex flex-col gap-2">
                        {/* Filter */}
                        <div className="grid grid-cols-2 p-10 gap-4 rounded-xl border border-gray-200 p-6 dark:border-gray-800 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] ">
                              <div>
                              ...
                              <div className="flex items-center justify-center gap-5 col-span-3">
                                    <Button name="generate" onClick={handleClick} className="w-1/3">
                                          Generate
                                    </Button>
                                    <Button name="clear" className="w-1/3" onClick={handleClick}>
                                          Clear
                                    </Button>
                              </div>
                        </div>
                                    ...
                                    <MultiSelect
                                          ...
                                          onChange={(values) => {
                                                ...
                                                setHeader(
                                                      values.map((value) => {
                                                            return (
                                                                  headerOptions.find((option) => option.value === value)
                                                                        ?.text || ""
                                                            );
                                                      }),
                                                );
