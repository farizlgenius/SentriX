...
public sealed class Position : BaseDomainEntity
{
      ...
      public Position(Guid guid, string name, string description,Guid departmentGuid, int locationId,bool isActive,bool IsDefault) : base(guid,locationId,isActive,IsDefault)
      {
